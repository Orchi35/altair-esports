...
const TRACKING_CHANNELS = Object.freeze({ ig:"instagram", tw:"twitch", yt:"youtube", dc:"discord" });
      ...
      <div className="container">
        ...
        <div className="broadcast-hub-layout">
          <a
            ...
            onClick={() => trackSocialOpen(TRACKING_CHANNELS[featuredChannel.cls], locale)}
          >
          ...
          <div className="broadcast-channel-list">
            {supportingChannels.map((channel) => (
              <a
                ...
                onClick={() => trackSocialOpen(TRACKING_CHANNELS[channel.cls], locale)}
              >
